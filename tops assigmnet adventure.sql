...
Calculate sales using QTY and unitprice from Sales OrderDetail.)*/
 ...
 create view vendor_detail as 
   select productvendor.productID,productvendor.vendorID,standardprice,lastreceiptcost,lastreceiptdate,vendor.accountnumber,vendor.name from vendor left join productvendor
